...
pub fn test_common_preprocessed_input_1() -> CommonPreprocessedInput<FrField> {
    ...
    CommonPreprocessedInput {
        ...
        // domain: domain.clone(),
        ql: <Polynomial<FrElement> as FFTPoly<FrField, FrField>>::interpolate_fft(&[
            -FieldElement::one(),
            -FieldElement::one(),
            FieldElement::zero(),
            FieldElement::one(),
        ...
        qr: <Polynomial<FrElement> as FFTPoly<FrField, FrField>>::interpolate_fft(&[
            FieldElement::zero(),
            FieldElement::zero(),
            FieldElement::zero(),
            -FieldElement::one(),
        ...
        qo: <Polynomial<FrElement> as FFTPoly<FrField, FrField>>::interpolate_fft(&[
            FieldElement::zero(),
            FieldElement::zero(),
            -FieldElement::one(),
            FieldElement::zero(),
        ...
        qm: <Polynomial<FrElement> as FFTPoly<FrField, FrField>>::interpolate_fft(&[
            FieldElement::zero(),
            FieldElement::zero(),
            FieldElement::one(),
            FieldElement::zero(),
        ...
        qc: <Polynomial<FrElement> as FFTPoly<FrField, FrField>>::interpolate_fft(&[
